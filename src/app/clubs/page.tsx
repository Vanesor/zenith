...
const getClubLogo = (clubName: string) => {
  ...
  const logoMap: { [key: string]: string } = {
    'ACHIEVERS': `${baseUrl}/uploads/club-logos/achievers.svg`,
    'ARTOVERT': `${baseUrl}/uploads/club-logos/artovert.svg`, 
    'ASCEND': `${baseUrl}/uploads/club-logos/ascend.svg`,
    'ASTER': `${baseUrl}/uploads/club-logos/aster.svg`
  };
