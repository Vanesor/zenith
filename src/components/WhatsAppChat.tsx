...
export default function WhatsAppChat({
  ...
  return (
    <div className="flex flex-col h-full bg-zenith-section dark:bg-gray-900">
      {/* Chat Header */}
      <div className="bg-card border-b border-custom dark:border-gray-700 px-6 py-4">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {!isOwn && (
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-primary text-xs font-semibold flex-shrink-0 ${
                  ...
                  <div className="flex flex-col">
                    ...
                    <div
                      className={`px-3 py-2 rounded-2xl relative shadow-md ${
                        isOwn
                          ? "bg-green-500 text-primary rounded-br-md" // WhatsApp green for own messages
                          : "bg-card dark:bg-gray-700 text-primary rounded-bl-md"
                      }`}
                    >
                      {/* Message tail */}
                      {isOwn ? (
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 transition-opacity p-1.5 text-zenith-muted hover:text-primary dark:hover:text-blue-400 bg-card dark:bg-gray-700 rounded-full shadow-md"
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border-t border-blue-200 dark:border-blue-700 px-4 py-3">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center space-x-2 mb-1">
                <Reply className="w-4 h-4 text-primary dark:text-blue-400" />
                <p className="text-sm font-semibold text-blue-800 dark:text-blue-200">
                  Replying to {replyTo.author_name}
                </p>
              </div>
              <p className="text-sm text-primary dark:text-blue-300 truncate pl-6">
                {replyTo.message}
              </p>
            </div>
            <button
      ...
      <div className="bg-zenith-section dark:bg-gray-800 px-4 py-3">
        <form onSubmit={handleSendMessage} className="flex items-end space-x-3">
          <div className="flex-1 bg-card dark:bg-gray-700 rounded-3xl border border-custom dark:border-gray-600 px-4 py-2">
            <textarea
              ref={messageInputRef}
              value={newMessage}
              ...
              className="w-full resize-none bg-transparent focus:outline-none dark:text-primary placeholder-gray-500 dark:placeholder-gray-400"
              rows={1}
          ...
          <button
            ...
            className="w-12 h-12 bg-green-500 hover:bg-green-600 text-primary rounded-full flex items-center justify-center transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
            {isSubmitting ? (
