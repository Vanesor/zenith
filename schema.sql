...
ALTER TABLE ONLY public.assignment_attempts
    ADD CONSTRAINT assignment_attempts_assignment_id_fkey FOREIGN KEY (assignment_id) REFERENCES public.assignments(id);


--
-- Name: assignment_attempts assignment_attempts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_attempts
    ADD CONSTRAINT assignment_attempts_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: assignment_audit_log assignment_audit_log_assignment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_audit_log
    ADD CONSTRAINT assignment_audit_log_assignment_id_fkey FOREIGN KEY (assignment_id) REFERENCES public.assignments(id);


--
-- Name: assignment_audit_log assignment_audit_log_attempt_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_audit_log
    ADD CONSTRAINT assignment_audit_log_attempt_id_fkey FOREIGN KEY (attempt_id) REFERENCES public.assignment_attempts(id);


--
-- Name: assignment_audit_log assignment_audit_log_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_audit_log
    ADD CONSTRAINT assignment_audit_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: assignment_submissions assignment_submissions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assignments assignments_club_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignments
    ADD CONSTRAINT assignments_club_id_fkey FOREIGN KEY (club_id) REFERENCES public.clubs(id);
...
ALTER TABLE ONLY public.chat_attachments
    ADD CONSTRAINT chat_attachments_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.chat_messages(id);


--
-- Name: chat_invitations chat_invitations_inviter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chat_invitations
    ADD CONSTRAINT chat_invitations_inviter_id_fkey FOREIGN KEY (inviter_id) REFERENCES public.users(id);


--
-- Name: chat_invitations chat_invitations_room_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chat_invitations
    ADD CONSTRAINT chat_invitations_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.chat_rooms(id);
...
ALTER TABLE ONLY public.chat_messages
    ADD CONSTRAINT chat_messages_reply_to_message_id_fkey FOREIGN KEY (reply_to_message_id) REFERENCES public.chat_messages(id);
...
--
-- Name: chat_room_members chat_room_members_chat_room_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chat_room_members
    ADD CONSTRAINT chat_room_members_chat_room_id_fkey FOREIGN KEY (chat_room_id) REFERENCES public.chat_rooms(id);
...
--
-- Name: chat_rooms chat_rooms_club_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chat_rooms
    ADD CONSTRAINT chat_rooms_club_id_fkey FOREIGN KEY (club_id) REFERENCES public.clubs(id);
...
--
-- Name: club_statistics club_statistics_club_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.club_statistics
    ADD CONSTRAINT club_statistics_club_id_fkey FOREIGN KEY (club_id) REFERENCES public.clubs(id);


--
-- Name: coding_submissions coding_submissions_question_response_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_submissions
    ADD CONSTRAINT coding_submissions_question_response_id_fkey FOREIGN KEY (question_response_id) REFERENCES public.question_responses(id);
...
ALTER TABLE ONLY public.committee_members
    ADD CONSTRAINT committee_members_committee_id_fkey FOREIGN KEY (committee_id) REFERENCES public.committees(id);


--
-- Name: committee_members committee_members_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.committee_members
    ADD CONSTRAINT committee_members_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.committee_roles(id);
...
--
-- Name: committee_roles committee_roles_committee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.committee_roles
    ADD CONSTRAINT committee_roles_committee_id_fkey FOREIGN KEY (committee_id) REFERENCES public.committees(id);


--
-- Name: discussion_replies discussion_replies_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.discussion_replies
    ADD CONSTRAINT discussion_replies_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.discussion_replies
    ADD CONSTRAINT discussion_replies_discussion_id_fkey FOREIGN KEY (discussion_id) REFERENCES public.discussions(id);


--
-- Name: discussion_replies discussion_replies_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.discussion_replies
    ADD CONSTRAINT discussion_replies_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.discussion_replies(id);
...
ALTER TABLE ONLY public.discussions
    ADD CONSTRAINT discussions_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.users(id);


--
-- Name: discussions discussions_club_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.discussions
    ADD CONSTRAINT discussions_club_id_fkey FOREIGN KEY (club_id) REFERENCES public.clubs(id);
...
--
-- Name: ai_assignment_generations fk_ai_generations_assignment; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_assignment_generations
    ADD CONSTRAINT fk_ai_generations_assignment FOREIGN KEY (generated_assignment_id) REFERENCES public.assignments(id);


--
-- Name: ai_assignment_generations fk_ai_generations_template; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_assignment_generations
    ADD CONSTRAINT fk_ai_generations_template FOREIGN KEY (template_id) REFERENCES public.assignment_templates(id);


--
-- Name: ai_assignment_generations fk_ai_generations_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_assignment_generations
    ADD CONSTRAINT fk_ai_generations_user FOREIGN KEY (generated_by) REFERENCES public.users(id);


--
-- Name: assignment_questions fk_assignment; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_questions
    ADD CONSTRAINT fk_assignment FOREIGN KEY (assignment_id) REFERENCES public.assignments(id);


--
-- Name: assignment_templates fk_assignment_templates_created_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_templates
    ADD CONSTRAINT fk_assignment_templates_created_by FOREIGN KEY (created_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.chat_messages
    ADD CONSTRAINT fk_chat_messages_thread FOREIGN KEY (thread_id) REFERENCES public.chat_messages(id);


--
-- Name: clubs fk_clubs_co_coordinator; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clubs
    ADD CONSTRAINT fk_clubs_co_coordinator FOREIGN KEY (co_coordinator_id) REFERENCES public.users(id);


--
-- Name: clubs fk_clubs_coordinator; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clubs
    ADD CONSTRAINT fk_clubs_coordinator FOREIGN KEY (coordinator_id) REFERENCES public.users(id);


--
-- Name: clubs fk_clubs_media; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clubs
    ADD CONSTRAINT fk_clubs_media FOREIGN KEY (media_id) REFERENCES public.users(id);


--
-- Name: clubs fk_clubs_secretary; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clubs
    ADD CONSTRAINT fk_clubs_secretary FOREIGN KEY (secretary_id) REFERENCES public.users(id);


--
-- Name: media_files fk_media_files_uploaded_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.media_files
    ADD CONSTRAINT fk_media_files_uploaded_by FOREIGN KEY (uploaded_by) REFERENCES public.users(id);


--
-- Name: proctoring_sessions fk_proctoring_sessions_assignment; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.proctoring_sessions
    ADD CONSTRAINT fk_proctoring_sessions_assignment FOREIGN KEY (assignment_id) REFERENCES public.assignments(id);


--
-- Name: proctoring_sessions fk_proctoring_sessions_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.proctoring_sessions
    ADD CONSTRAINT fk_proctoring_sessions_user FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: question_options fk_question; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.question_options
    ADD CONSTRAINT fk_question FOREIGN KEY (question_id) REFERENCES public.assignment_questions(id);


--
-- Name: question_responses fk_question; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: question_media fk_question_media_file; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.question_media
    ADD CONSTRAINT fk_question_media_file FOREIGN KEY (media_file_id) REFERENCES public.media_files(id);


--
-- Name: question_media fk_question_media_question; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.question_media
    ADD CONSTRAINT fk_question_media_question FOREIGN KEY (question_id) REFERENCES public.assignment_questions(id);


--
-- Name: code_results fk_response; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.code_results
    ADD CONSTRAINT fk_response FOREIGN KEY (response_id) REFERENCES public.question_responses(id);


--
-- Name: assignment_violations fk_submission; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assignment_violations
    ADD CONSTRAINT fk_submission FOREIGN KEY (submission_id) REFERENCES public.assignment_submissions(id);


--
-- Name: question_responses fk_submission; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_club_id_fkey FOREIGN KEY (club_id) REFERENCES public.clubs(id);


--
-- Name: posts posts_edited_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_edited_by_fkey FOREIGN KEY (edited_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.project_members
    ADD CONSTRAINT project_members_invited_by_fkey FOREIGN KEY (invited_by) REFERENCES public.users(id);
...
--
-- Name: projects projects_club_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.projects
    ADD CONSTRAINT projects_club_id_fkey FOREIGN KEY (club_id) REFERENCES public.clubs(id);
